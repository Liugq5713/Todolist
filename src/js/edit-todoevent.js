...
//获取遮罩
  const mask=document.querySelector('.mask');
     // 让表单显示
  TODO.styleAdd(editEventForm,'form-show');
  TODO.styleDel(editEventForm,'form-hidden');
    // 显示遮罩层
  TODO.styleAdd(mask,'mask-show');
  TODO.styleDel(mask,'mask-hidden');
}
// 隐藏编辑表单
function formHidden() {
    // 获取到表单
  const editEventForm = document.querySelector('#editEventForm');
    // 让表单显示
  TODO.styleDel(editEventForm,'form-show');
  TODO.styleAdd(editEventForm,'form-hidden');
 
    // 显示遮罩层
  const mask=document.querySelector('.mask');
  TODO.styleAdd(mask,'mask-hidden');
  TODO.styleDel(mask,'mask-show');
}
